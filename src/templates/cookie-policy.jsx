...
class CookiePolicyPage extends React.Component {
    ...
    render() { 
        ...
        return (  
            <React.Fragment>
                <Helmet>
                    <title>{"Cookie Policy - " + t("maintitle")}</title>
                </Helmet>
                <PageHeader />
                <div className="container">
                    <div className="row">
                        <div className="col-md-10 offset-md-1" style={{marginTop: "2em", marginBottom: "2em"}}>
                            <h1>Cookie Policy for Spellware Studios</h1>

                            <p>This is the Cookie Policy for Spellware Studios, accessible from www.spellwarestudios.com</p>
